...
void loop()
{
  ...
  leds.setPixelColor(index, 127, 127, 127);
  leds.show();
  delay(100);
  
  /*for (int i=0; i < LED_COUNT; i++)
  {
    leds.setPixelColor(i, i%127, i%127, i%127);
  }
  leds.show();*/
  /*delay(1000);  
  for (int i=0; i < LED_COUNT; i++)
...
void rainbow(byte startPosition) 
{
  ...
  for (int i=0; i<LED_COUNT; i++)
  {
    ...
    leds.setPixelColor(i, rainbowOrder(((i + startPosition)) % 192));
    else
     leds.setPixelColor(i, rainbowOrder(((i- 192 + startPosition)) % 192));
  }
